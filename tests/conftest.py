...
def my_tf2_input(my_time_series_expressions):
    ...
    my_time_series_expressions.save_tf_produced_by_module_file(
        Path(
            f'../data/time_series_datasets/tf2network_approach/{total_genes}_highest_mad/02_gene_to_module.csv'),
...
def my_tf2_ode(my_tf2_input: ExpressionMatrixTimeSeries):
    ...
    my_grn = ModuleRegulatoryNetwork.from_tf2_tsv(
        Path(
            f'../data/time_series_datasets/tf2network_approach/{total_genes}_highest_mad/03_tf2network_output.tsv'))
