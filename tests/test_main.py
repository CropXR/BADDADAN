...
def test_compare_clusterings():
    ...
    for method in ['mad', 'cv', 'qcd']:
        ...
        log2_cluster = Path(f'../data/time_series_datasets/tf2network_approach/2000_highest_{method}_log2/01_tf2network_input_2000_highest_{method}_genes.txt')
        raw_cluster = Path(f'../data/time_series_datasets/tf2network_approach/2000_highest_{method}_no_log2/01_tf2network_input_2000_highest_{method}_genes.txt')
